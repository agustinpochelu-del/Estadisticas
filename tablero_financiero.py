...
st.markdown(
    ...
    /* Sticky Header con Coimport streamlit as st
import pandas as pd
import plotly.graph_objects as go
import numpy as np
import streamlit.components.v1 as components
...
if archivo_subido is not None:
    ...
    st.info("👆 Por favor, abrí el panel de la barra lateral izquierda y subí el archivo Excel (.xlsx) para comenzar el análisis.")ntraste Oscuro */
    div[data-testid="stVerticalBlock"] > div:has(div.sticky-header) {
