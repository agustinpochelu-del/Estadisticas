...
if archivo_subido is not None:
    ...
    df_pivot = df_historico.groupimport streamlit as st
import pandas as pd
import plotly.express as px
import plotly.graph_objects as go
import numpy as np
...
if archivo_subido is not None:
    ...
    st.info("👆 Por favor, subí el archivo Excel (.xlsx) para comenzar el análisis.")by(['Periodo', 'Cuenta'])['Saldos Ajustados'].sum().unstack(fill_value=0)
